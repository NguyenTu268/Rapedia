        ...
        <div class="post">
            <div class="card-body">
                ...
                <div class="col-md-10 ml-auto mr-auto">
                    <form method="post" action="update-news/{{$edit->id}}" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        @endif
                        <h4>Title:</h4><input type="text" name="title" onload="convertToSlug(this.value)" onkeyup="convertToSlug(this.value)" style="width: 100%; height: 50px; font-size: 20px;" value="{{$edit->title}}"></br>
                ...
                @else 
                <div class="col-md-10 ml-auto mr-auto">
                    <form method="post" action="post-news" enctype="multipart/form-data">
                        {{csrf_field()}}
                        @if ($message = Session::get('success'))
                        <div class="alert alert-success">
                            <strong>{{ $message }}</strong>
                        ...
                        @endif
                        <h4>Title:</h4><input type="text" name="title" onload="convertToSlug(this.value)" onkeyup="convertToSlug(this.value)" style="width: 100%; height: 50px; font-size: 20px;"></br>
                        ...
                        <h4>Ảnh</h4><input type="file" name="file"></br>
                        <input type="submit" name="post-news" value="Đăng thông báo" class="btn-danger btn-submit">
                    </form>
                </div>
                @endif
            </div>
