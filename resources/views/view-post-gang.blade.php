            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{URL::to('/view-post')}}">View Posts</a>
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">All of the posts</h1>
            ...
            <div class="card-body">
                <div class="col-md-10 ml-auto mr-auto">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th scope="row">{{$value->idname}}</th>
                      <td><img src="{{asset($value->image)}}" alt="" style="width: 100px; height: 100px;"></td>
                      <td>{{$value->name}}</td>
                      <td>{!!$value->content2!!}</td>
                      <td><a href="edit-gang/{{$value->id}}" title="">Edit</a></td>
                      <td><a href="delete-gang/{{$value->id}}" title="">Delete</a></td>
                  </tr>
                    @endforeach
              </tbody>
          </table>
