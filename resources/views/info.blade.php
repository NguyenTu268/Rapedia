					...
					<div id="stickySidebar">
						<div class="widget-item">
							<div class="rating-widget">
								...
								<ul>
									<li>Tên thật<span>Nghiêm Vũ Hoàng Long</span></li>
									<li>Nickname<span>MCK, RPT MCK, McKey, Ngơ, Nger</span></li> 
									<li>Nhóm<span>Rapital, CDSL</span></li>
									<li>Bạn bè/Đồng minh/Hợp tác<span>Karik, Justatee, Wowy</span></li>
									<li>Đối thủ/Kẻ thù/Beef với<span>Osad, B2C
									</span></li>
									<li>D.O.B<span>
									2.3.1999</span></li>
								</ul>
