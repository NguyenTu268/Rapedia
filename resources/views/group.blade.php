...
<body>
	...
	<section class="games-section">
		<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-8">
						<div class="review-content text-box text-white">
							...
							<div class="top-meta">{{ $value->created_at->format('d.m.Y') }}  /  in <a href="">Group</a></div>
							<h3>{{$value->name}}</h3>
			...
			<a href="{{URL::to('gang/'.($currentPage-1))}}">Previous</a>
				@else
				<a href="">Previous</a>
				@endif
				...
				@else
				@if($i == $currentPage)
				<a href="{{URL::to('gang/'.$i)}}" class="active">{{$i}}</a>
				@else
				<a href="{{URL::to('gang/'.$i)}}">{{$i}}</a>
				@endif
				@endif
				...
				<a href="{{URL::to('gang/'.($currentPage+1))}}">Next</a>
				@else
				<a href="">Next</a>
				@endif
